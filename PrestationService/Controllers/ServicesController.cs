...
namespace PrestationService.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.IdProfessionnel = new SelectList(db.professionnels, "IdProfessionnel", "diplome");
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.IdProfessionnel = new SelectList(db.professionnels, "IdProfessionnel", "diplome", service.IdProfessionnel);
            ViewBag.idSouCat = new SelectList(db.SousCategories, "idSouCat", "libSouCat", service.idSouCat);
            return View(service);
        }
