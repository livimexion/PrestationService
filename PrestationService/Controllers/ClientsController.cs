...
namespace PrestationService.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdClient,nom,prenom,naissance,adresse,mail,tel,identification")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdClient,nom,prenom,naissance,adresse,mail,tel,identification")] Client client)
        {
            if (ModelState.IsValid)
            {
